...
class SpeedRunChallenge(BaseChallenge):
    ...
    def create(request):
        ...
        challenge = SpeedrunChallenge(**data)
    ...
    def read(challenge):
        ...
        """
        challenge = SpeedrunChallenge.query.filter_by(id=challenge.id).first()
        data = {
            "id": challenge.id,
            "name": challenge.name,
            ...
            "type": challenge.type,
            "type_data": {
                "id": SpeedRunChallenge.id,
                "name": SpeedRunChallenge.name,
                "templates": SpeedRunChallenge.templates,
                "scripts": SpeedRunChallenge.scripts,
            },
        }
        return data
    ...
    def delete(challenge):
        ...
        SpeedrunChallenge.query.filter_by(id=challenge.id).delete()
    ...
    def solve(user, team, challenge, request):
        ...
        :return:
        """
        chal = SpeedrunChallenge.query.filter_by(id=challenge.id).first()
        data = request.form or request.get_json()
        submission = data["submission"].strip()
...
class SpeedrunChallenge(Challenges):
    ...
    def __init__(self, *args, **kwargs):
        super(SpeedrunChallenge, self).__init__(**kwargs)
